...
if ("undefined" == typeof jQuery) {
    ...
    j.VERSION = "3.3.4", j.TRANSITION_DURATION = 600, j.DEFAULTS = {
        ...
        var u = this.$element.find(".item.active"),
            t = v || this.getItemForDirection(w, u),
            r = this.interval,
            q = "next" == w ? "left" : "right",
            p = this;
        ...
        if (/(38|40|27|32)/.test(a.which) && !/input|textarea/i.test(a.target.tagName)) {
            ...
            if (a.preventDefault(), a.stopPropagation(), !u.is(".disabled, :disabled")) {
                ...
                var q = " li:not(.disabled):visible a",
                    f = t.find('[role="menu"]' + q + ', [role="listbox"]' + q);
                if (f.length) {
    ...
    function f(a, c) {
        return this.each(function() {
            var j = g(this),
                d = j.data("bs.modal"),
                b = g.extend({}, i.DEFAULTS, j.data(), "object" == typeof a && a);
    ...
    g.fn.modal = f, g.fn.modal.Constructor = i, g.fn.modal.noConflict = function() {
        ...
        var k = g(this),
            j = k.attr("href"),
            b = g(k.attr("data-target") || j && j.replace(/.*(?=#[^\s]+$)/, "")),
    ...
    i.VERSION = "3.3.4", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        return d && d.$tip && d.$tip.hasClass("in") ? void(d.hoverState = "in") : (d || (d = new this.constructor(a.currentTarget, this.getDelegateOptions()), g(a.currentTarget).data("bs." + this.type, d)), clearTimeout(d.timeout), d.hoverState = "in", d.options.delay && d.options.delay.show ? void(d.timeout = setTimeout(function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (z) {
                var v = B,
                    u = this.options.container ? g(this.options.container) : this.$element.parent(),
        ...
        var l = n ? {
            ...
            k = {
                scroll: n ? document.documentElement.scrollTop || document.body.scrollTop : a.scrollTop()
            },
            j = n ? {
        ...
        if (/right|left/.test(w)) {
            var o = v.top - q - p.scroll,
                n = v.top + q - p.scroll + t;
    ...
    f.VERSION = "3.3.4", f.DEFAULTS = {
        ...
        var k = this.selector + '[data-target="' + a + '"],' + this.selector + '[href="' + a + '"]',
            j = g(k).parents("li").addClass("active");
...
! function(b) {
    ...
    ax.prototype = {
        ...
        updateSize: function(b) {
            if (aP.isIOS) {
                var g = document.documentElement.clientWidth / window.innerWidth,
                    f = window.innerHeight * g;
...
(function(d) {
    ...
    b.prototype = {
        ...
        createDropdown: function() {
            var j = this.multiple ? " show-tick" : "",
                k = this.$element.parent().hasClass("input-group") ? " input-group-btn" : "",
        ...
        createLi: function() {
            ...
            this.$element.find("option").each(function() {
                ...
                var o = r.attr("class") || "",
                    q = r.attr("style"),
                    x = r.data("content") ? r.data("content") : r.html(),
                    v = typeof r.data("subtext") !== "undefined" ? '<small class="muted text-muted">' + r.data("subtext") + "</small>" : "",
                    t = typeof r.data("icon") !== "undefined" ? '<span class="' + l.options.iconBase + " " + r.data("icon") + '"></span> ' : "",
                    w = r.is(":disabled") || r.parent().is(":disabled"),
                    p = r[0].index;
                if (t !== "" && w) {
                    t = "<span>" + t + "</span>"
                }
        ...
        liHeight: function() {
            ...
            var l = this.$menu.parent().clone().find("> .dropdown-toggle").prop("autofocus", false).end().appendTo("body"),
                m = l.addClass("open").find("> .dropdown-menu"),
                k = m.find("li").not(".divider").not(".dropdown-header").filter(":visible").children("a").outerHeight(),
                j = this.options.header ? m.find(".popover-title").outerHeight() : 0,
                n = this.options.liveSearch ? m.find(".bs-searchbox").outerHeight() : 0,
                i = this.options.actionsBox ? m.find(".bs-actionsbox").outerHeight() : 0;
            l.remove();
        ...
        setSize: function() {
            ...
            var o = this,
                j = this.$menu,
                p = j.find(".inner"),
                B = this.$newElement.outerHeight(),
                l = this.$newElement.data("liHeight"),
                z = this.$newElement.data("headerHeight"),
                t = this.$newElement.data("searchHeight"),
                n = this.$newElement.data("actionsHeight"),
                r = this.$lis.filter(".divider").outerHeight(true),
                y = parseInt(j.css("padding-top")) + parseInt(j.css("padding-bottom")) + parseInt(j.css("border-top-width")) + parseInt(j.css("border-bottom-width")),
                w = this.options.hideDisabled ? ", .disabled" : "",
                v = d(window),
                m = y + parseInt(j.css("margin-top")) + parseInt(j.css("margin-bottom")) + 2,
                x, C, A, q = function() {
        ...
        clickListener: function() {
            ...
            this.$menu.on("click", "li a", function(z) {
                var o = d(this),
                    j = o.parent().data("originalIndex"),
                    x = i.$element.val(),
                    q = i.$element.prop("selectedIndex");
                if (i.multiple) {
                    z.stopPropagation()
                }
                z.preventDefault();
                if (!i.isDisabled() && !o.parent().hasClass("disabled")) {
                    var v = i.$element.find("option"),
                        w = v.eq(j),
                        l = w.prop("selected"),
                        u = w.parent("optgroup"),
                        B = i.options.maxOptions,
                        r = u.data("maxOptions") || false;
                    if (!i.multiple) {
                        ...
                        o.blur();
                        if ((B !== false) || (r !== false)) {
                            var k = B < v.filter(":selected").length,
                                n = r < u.find("option:selected").length;
                            if ((B && k) || (r && n)) {
                                if (B && B == 1) {
                                    v.prop("selected", false);
                                    w.prop("selected", true);
                                    ...
                                    if (r && r == 1) {
                                        ...
                                        var m = (typeof i.options.maxOptionsText === "function") ? i.options.maxOptionsText(B, r) : i.options.maxOptionsText,
                                            A = m[0].replace("{n}", B),
                                            p = m[1].replace("{n}", r),
        ...
        keydown: function(v) {
            var w = d(this),
                n = (w.is("input")) ? w.parent().parent() : w.parent(),
                u, r = n.data("this"),
                t, p, o, x, k, m, j, y, l = {
                    32: " ",
                    48: "0",
...
! function(b) {
    ...
    a.DEFAULTS = {
        ...
        tabsClass: "hidden-xs",
        accordionTemplate: function(f, c, g, d) {
    ...
    a.prototype.showTabs = function() {
        ...
        f.each(function() {
            var h = b(this),
                j = h.data("bs.tabcollapse.parentLi");
        ...
        c.each(function() {
            var i = b(this),
                h = i.data("bs.tabcollapse.tabpane");
        ...
        if (this.options.updateLinks) {
            ...
            g.find('[data-toggle-was="tab"], [data-toggle-was="pill"]').each(function() {
                ...
                i.attr({
                    "data-toggle": i.attr("data-toggle-was"),
                    "data-toggle-was": "",
                    "data-parent": "",
                    href: h
                })
    ...
    a.prototype._createAccordionGroup = function(j, g) {
        var f = g.attr("data-target"),
            h = g.data("bs.tabcollapse.parentLi").is(".active");
        if (!f) {
            f = g.attr("href");
            f = f && f.replace(/.*(?=#[^\s]*$)/, "")
        }
        var c = b(f),
            ...
            i = b(this.options.accordionTemplate(g, d, j, h));
...
(function(b, a, c, d) {
    c.swipebox = function(j, v) {
        var t, n = {
            ...
            g, k = j.selector,
            u = c(k),
            r = navigator.userAgent.match(/(iPad)|(iPhone)|(iPod)|(Android)|(PlayBook)|(BB10)|(BlackBerry)|(Opera Mini)|(IEMobile)|(webOS)|(MeeGo)/i),
            m = r !== null || a.createTouch !== d || ("ontouchstart" in b) || ("onmsgesturechange" in b) || navigator.msMaxTouchPoints,
            o = !!a.createElementNS && !!a.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
            i = b.innerWidth ? b.innerWidth : c(b).width(),
            l = b.innerHeight ? b.innerHeight : c(b).height(),
            h = 0,
            p = '<div id="swipebox-overlay">					<div id="swipebox-container">						<div id="swipebox-slider"></div>						<div id="swipebox-top-bar">							<div id="swipebox-title"></div>						</div>						<div id="swipebox-bottom-bar">							<div id="swipebox-arrows">								<a id="swipebox-prev"></a>								<a id="swipebox-next"></a>							</div>						</div>						<a id="swipebox-close"></a>					</div>			</div>';
        q.settings = {};
        ...
        t = {
            ...
            supportTransition: function() {
                var x = "transition WebkitTransition MozTransition OTransition msTransition KhtmlTransition".split(" "),
                    w;
            ...
            gesture: function() {
                var G = this,
                    ...
                    J = {},
                    w = {},
                    K = c("#swipebox-top-bar, #swipebox-bottom-bar"),
                    x = c("#swipebox-slider");
            ...
            animBars: function() {
                var x = this,
                    w = c("#swipebox-top-bar, #swipebox-bottom-bar");
                w.addClass("visible-bars");
                x.setTimeout();
            ...
            getVideo: function(y) {
                var A = "",
                    x = y.match(/((?:www\.)?youtube\.com|(?:www\.)?youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/),
                    z = y.match(/(?:www\.)?youtu\.be\/([a-zA-Z0-9\-_]+)/),
                    B = y.match(/(?:www\.)?vimeo\.com\/([0-9]*)/),
                    w = "";
                if (x || z) {
                    if (z) {
                        x = z
            ...
            getNext: function() {
                var x = this,
                    y, w = c("#swipebox-slider .slide").index(c("#swipebox-slider .slide.current"));
                if (w + 1 < f.length) {
            ...
            getPrev: function() {
                var w = c("#swipebox-slider .slide").index(c("#swipebox-slider .slide.current")),
                    x;
                if (w > 0) {
...
! function() {
    ...
    window.Swiper = function(al, ap) {
            ...
            if (!(v.shiftKey || v.altKey || v.ctrlKey || v.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
                if (37 === x || 39 === x || 38 === x || 40 === x) {
                    ...
                    for (var g = {
                        ...
                        }, u = window.innerWidth, m = window.innerHeight, k = ak.container.offset(), t = [
                            [k.left, k.top],
                            [k.left + ak.width, k.top],
                            [k.left, k.top + ak.height],
                            [k.left + ak.width, k.top + ak.height]
                        ], h = 0; h < t.length; h++) {
                        var w = t[h];
        ...
        if (ai = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7, ai && (ak.$ = ai, ak.container = ai(al), 0 !== ak.container.length)) {
            ...
            ak.container[0].swiper = ak, ak.container.data("swiper", ak), ak.classNames.push("swiper-container-" + ak.params.direction), ak.params.freeMode && ak.classNames.push("swiper-container-free-mode"), ak.support.flexbox || (ak.classNames.push("swiper-container-no-flexbox"), ak.params.slidesPerColumn = 1), (ak.params.parallax || ak.params.watchSlidesVisibility) && (ak.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(ak.params.effect) >= 0 && (ak.support.transforms3d ? (ak.params.watchSlidesProgress = !0, ak.classNames.push("swiper-container-3d")) : ak.params.effect = "slide"), "slide" !== ak.params.effect && ak.classNames.push("swiper-container-" + ak.params.effect), "cube" === ak.params.effect && (ak.params.resistanceRatio = 0, ak.params.slidesPerView = 1, ak.params.slidesPerColumn = 1, ak.params.slidesPerGroup = 1, ak.params.centeredSlides = !1, ak.params.spaceBetween = 0, ak.params.virtualTranslate = !0, ak.params.setWrapperSize = !1), "fade" === ak.params.effect && (ak.params.slidesPerView = 1, ak.params.slidesPerColumn = 1, ak.params.slidesPerGroup = 1, ak.params.watchSlidesProgress = !0, ak.params.spaceBetween = 0, "undefined" == typeof U && (ak.params.virtualTranslate = !0)), ak.params.grabCursor && ak.support.touch && (ak.params.grabCursor = !1), ak.wrapper = ak.container.children("." + ak.params.wrapperClass), ak.params.pagination && (ak.paginationContainer = ai(ak.params.pagination), ak.params.paginationClickable && ak.paginationContainer.addClass("swiper-pagination-clickable")), ak.rtl = W() && ("rtl" === ak.container[0].dir.toLowerCase() || "rtl" === ak.container.css("direction")), ak.rtl && ak.classNames.push("swiper-container-rtl"), ak.rtl && (ak.wrongRTL = "-webkit-box" === ak.wrapper.css("display")), ak.params.slidesPerColumn > 1 && ak.classNames.push("swiper-container-multirow"), ak.device.android && ak.classNames.push("swiper-container-android"), ak.container.addClass(ak.classNames.join(" ")), ak.translate = 0, ak.progress = 0, ak.velocity = 0, ak.lockSwipeToNext = function() {
                ...
                var C, G = ak.params.spaceBetween,
                    L = 0,
                    g = 0,
                    y = 0;
                ...
                for (C = 0; C < ak.slides.length; C++) {
                    ...
                    if (ak.params.slidesPerColumn > 1) {
                        ...
                        "column" === ak.params.slidesPerColumnFill ? (D = Math.floor(C / w), I = C - D * w, k = D + I * v / w, x.css({
                            ...
                            "-webkit-order": k,
                            order: k
                        })) : (E = v / w, I = Math.floor(C / E), D = C - I * E), x.css({
                            "margin-top": 0 !== I && ak.params.spaceBetween && ak.params.spaceBetween + "px"
                        }).attr("data-swiper-column", D).attr("data-swiper-row", I)
                    }
                ...
                var z;
                if (ak.rtl && ak.wrongRTL && ("slide" === ak.params.effect || "coverflow" === ak.params.effect) && ak.wrapper.css({
                        width: ak.virtualSize + ak.params.spaceBetween + "px"
                    }), (!ak.support.flexbox || ak.params.setWrapperSize) && ak.wrapper.css(W() ? {
                        width: ak.virtualSize + ak.params.spaceBetween + "px"
                    } : {
                        height: ak.virtualSize + ak.params.spaceBetween + "px"
                    }), ak.params.slidesPerColumn > 1 && (ak.virtualSize = (t + ak.params.spaceBetween) * v, ak.virtualSize = Math.ceil(ak.virtualSize / ak.params.slidesPerColumn) - ak.params.spaceBetween, ak.wrapper.css({
                        width: ak.virtualSize + ak.params.spaceBetween + "px"
                    }), ak.params.centeredSlides)) {
                ...
                0 === ak.snapGrid.length && (ak.snapGrid = [0]), 0 !== ak.params.spaceBetween && ak.slides.css(W() ? ak.rtl ? {
                    marginLeft: G + "px"
                } : {
                    marginRight: G + "px"
                } : {
                    marginBottom: G + "px"
                }), ak.params.watchSlidesProgress && ak.updateSlidesOffset()
                ...
                if ("undefined" == typeof v && (v = ak.translate || 0), 0 !== ak.slides.length) {
                    ...
                    for (var x = 0; x < ak.slides.length; x++) {
                        var g = ak.slides[x],
                            u = ak.params.centeredSlides === !0 ? g.swiperSlideSize / 2 : 0,
                            m = (w - g.swiperSlideOffset - u) / (g.swiperSlideSize + ak.params.spaceBetween);
                        if (ak.params.watchSlidesVisibility) {
                            var k = -(w - g.swiperSlideOffset - u),
                                t = k + ak.slidesSizesGrid[x],
                                h = k >= 0 && k < ak.size || t > 0 && t <= ak.size || 0 >= k && t >= ak.size;
            ...
            window.navigator.pointerEnabled ? R = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (R = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), ak.touchEvents = {
                ...
                var g = l ? "off" : "on",
                    h = l ? "removeEventListener" : "addEventListener",
                    k = "container" === ak.params.touchEventsTarget ? ak.container[0] : ak.wrapper[0],
                    a = ak.support.touch ? k : document,
                    m = ak.params.nested ? !0 : !1;
            ...
            var aj, O, ao, J, N, j, q, Z, B, A = "input, select, textarea, button",
                H = Date.now(),
                K = [];
            ak.animating = !1, ak.touches = {
                startX: 0,
                startY: 0,
                currentX: 0,
                currentY: 0,
            ...
            if (ak.onTouchStart = function(h) {
                    ...
                    if (aq.originalEvent && (aq = aq.originalEvent), ak.emit("onTouchEnd", ak, aq), aj) {
                        ...
                        if (C = ak.params.followFinger ? ak.rtl ? ak.translate : -ak.translate : -N, ak.params.freeMode) {
                            ...
                            if (ak.params.freeModeMomentum) {
                                ...
                                K.length = 0;
                                var M = 1000 * ak.params.freeModeMomentumRatio,
                                    E = ak.velocity * M,
                                    ar = ak.translate + E;
                                ak.rtl && (ar = -ar);
                                var x, at = !1,
                                    L = 20 * Math.abs(ak.velocity) * ak.params.freeModeMomentumBounceRatio;
                    ...
                    fade: {
                        ...
                        setTranslate: function() {
                            for (var m = 0; m < ak.slides.length; m++) {
                                var g = ak.slides.eq(m),
                                    k = g[0].swiperSlideOffset,
                                    l = -k;
                                ...
                                o > 0 && 1 > o && (ak.effects.fade.fadeIndex = m), g.css({
                                    opacity: o
                                }).transform("translate3d(" + l + "px, " + h + "px, 0px)")
                            }
                        },
                    ...
                    cube: {
                        setTranslate: function() {
                            var aq, av = 0;
                            ak.params.cube.shadow && (W() ? (aq = ak.wrapper.find(".swiper-cube-shadow"), 0 === aq.length && (aq = ai('<div class="swiper-cube-shadow"></div>'), ak.wrapper.append(aq)), aq.css({
                                height: ak.width + "px"
                            })) : (aq = ak.container.find(".swiper-cube-shadow"), 0 === aq.length && (aq = ai('<div class="swiper-cube-shadow"></div>'), ak.container.append(aq))));
                            for (var D = 0; D < ak.slides.length; D++) {
                                var E = ak.slides.eq(D),
                                    S = 90 * D,
                                    L = Math.floor(S / 360);
                                ...
                                if (1 >= I && I > -1 && (av = 90 * D + 90 * I, ak.rtl && (av = 90 * -D - 90 * I)), E.transform(C), ak.params.cube.slideShadows) {
                                    var at = E.find(W() ? ".swiper-slide-shadow-left" : ".swiper-slide-shadow-top"),
                                        M = E.find(W() ? ".swiper-slide-shadow-right" : ".swiper-slide-shadow-bottom");
                            ...
                            if (ak.wrapper.css({
                                ...
                                if (W()) {
                                    ...
                                    var z = Math.abs(av) - 90 * Math.floor(Math.abs(av) / 90),
                                        T = 1.5 - (Math.sin(2 * z * Math.PI / 360) / 2 + Math.cos(2 * z * Math.PI / 360) / 2),
                                        t = ak.params.cube.shadowScale,
                                        au = ak.params.cube.shadowScale / T,
                                        h = ak.params.cube.shadowOffset;
                    ...
                    coverflow: {
                        setTranslate: function() {
                            for (var aq = ak.translate, av = W() ? -aq + ak.width / 2 : -aq + ak.height / 2, D = W() ? ak.params.coverflow.rotate : -ak.params.coverflow.rotate, E = ak.params.coverflow.depth, S = 0, L = ak.slides.length; L > S; S++) {
                                var I = ak.slides.eq(S),
                                    P = ak.slidesSizesGrid[S],
                                    G = I[0].swiperSlideOffset,
                                    ar = (av - G - P / 2) / P * ak.params.coverflow.modifier,
                                    C = W() ? D * ar : 0,
                                    at = W() ? 0 : D * ar,
                                    M = -E * Math.abs(ar),
                                    z = W() ? 0 : ak.params.coverflow.stretch * ar,
                                    T = W() ? ak.params.coverflow.stretch * ar : 0;
                                ...
                                if (I.transform(t), I[0].style.zIndex = -Math.abs(Math.round(ar)) + 1, ak.params.coverflow.slideShadows) {
                                    var au = I.find(W() ? ".swiper-slide-shadow-left" : ".swiper-slide-shadow-top"),
                                        h = I.find(W() ? ".swiper-slide-shadow-right" : ".swiper-slide-shadow-bottom");
                    ...
                    loadImageInSlide: function(i) {
                        if ("undefined" != typeof i && 0 !== ak.slides.length) {
                            var g = ak.slides.eq(i),
                                h = g.find("img.swiper-lazy:not(.swiper-lazy-loaded):not(.swiper-lazy-loading)");
                    ...
                    setTranslate: function() {
                        if (ak.params.scrollbar) {
                            var i, g = ak.scrollbar,
                                h = (ak.translate || 0, g.dragSize);
            ...
            ak.disableMousewheelControl = function() {
                ...
                setTransition: function(a) {
                    "undefined" == typeof a && (a = ak.params.speed), ak.container.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function() {
                        var g = ai(this),
                            h = parseInt(g.attr("data-swiper-parallax-duration"), 10) || a;
        ...
        device: function() {
            var j = navigator.userAgent,
                g = j.match(/(Android);?[\s\/]+([\d.]+)?/),
                h = j.match(/(iPad).*OS\s([\d_]+)/),
                i = (j.match(/(iPod)(.*OS\s([\d_]+))?/), !h && j.match(/(iPhone\sOS)\s([\d_]+)/));
            return {
                ios: h || i || h,
                android: g
            }
    ...
    d = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7, d && ("transitionEnd" in d.fn || (d.fn.transitionEnd = function(k) {
        ...
        var h, i = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"],
            j = this;
        if (k) {
...
(function(g, i, j, b) {
    ...
    var h = "sharrre",
        ...
        l = {
            googlePlus: function(n) {
                ...
                i.___gcfg = {
                    lang: n.options.buttons.googlePlus.lang
                };
                var p = 0;
            ...
            digg: function(n) {
                ...
                if (typeof __DBW === "undefined" && p == 0) {
                    ...
                    (function() {
                        var r = j.createElement("SCRIPT"),
                            q = j.getElementsByTagName("SCRIPT")[0];
                        r.type = "text/javascript";
                        r.async = true;
    ...
    k.prototype.getSocialJson = function(p) {
        var n = this,
            q = 0,
            o = c[p].replace("{url}", encodeURIComponent(this.options.url));
...
var Theme = {
    ...
    initGoogleMap: function(c) {
        ...
        if (c.full_width) {
            var i = function() {
                f.width(jQuery(window).outerWidth()).offset({
                    left: 0
                });
                if (h) {
                    if (a) {
        ...
        var a = new google.maps.LatLng(parseFloat(c.coordinates[0]), parseFloat(c.coordinates[1])),
            h = new google.maps.Map(d, {
                scaleControl: true,
                center: a,
                zoom: c.zoom,
    ...
    initStickyHeader: function() {
        var i = jQuery(document),
            d = false,
            f = jQuery(".header-wrap"),
            h = f.find(".header__info"),
            g = f.find(".header-wrap__backlog"),
            b = "header-wrap--sticky-header",
            c = null,
            j = 0,
            a = function() {
                c = h.outerHeight() + j;
                g.css({
                    "min-height": f.find(".header__content-wrap").outerHeight() + "px",
                    "margin-top": c + "px"
                })
            };
        setTimeout(a, 10);
    ...
    _initMobileMenu: function() {
        var b, a = "slicknav_btn--close",
            d = "slicknav_item",
            c = "slicknav_item--open";
    ...
    initSelectpicker: function(c) {
        var b = this,
            d = c ? jQuery(c) : null;
        if (null == d) {
            d = jQuery("select.selectpicker").add(".widget select").add("select.orderby").add(".wcml_currency_switcher")
        }
        if (!d || d.length < 1) {
            return false
        }
        var a = this.selectiper_live_search_auto_start;
        if (a > 0) {
            d.each(function() {
                if (this.children.length >= a && !this.hasAttribute("data-live-search")) {
                    jQuery(this).attr("data-live-search", true)
                }
            })
        }
        d.selectpicker().on("change", function() {
            b._fixSelectpickerEmptyClass(this)
        }).each(function() {
            b._fixSelectpickerEmptyClass(this)
        })
    },
    _fixSelectpickerEmptyClass: function(c) {
        var b = jQuery(c),
            d = b.data("selectpicker") ? true : false;
        if (!d) {
            return
        }
    ...
    _initTourSerchForm: function(b, a) {
        var f = b ? jQuery(b) : jQuery("form").has("input[name=toursearch]");
        if (f.length < 1) {
            return
        }
        var d = f.find('[name*="_date"]');
        if (d.length && jQuery.fn.datepicker) {
            var c = this;
            d.each(function() {
                var i = jQuery(this),
                    g = {},
                    ...
                    j;
                for (data_key_name in h) {
                    j = i.data(data_key_name);
                    if (j) {
                        g[h[data_key_name]] = j
                    }
                }
                g.onClose = function(k, l) {
                    c._tourSearchFormOnDateFieldCloseCallback(l.input[0])
                };
                i.datepicker(g)
            }).each(function() {
                if (this.value != "") {
                    c._tourSearchFormOnDateFieldCloseCallback(this)
                }
            })
        }
        f.on("submit", function() {
            jQuery(this).find("select" + (!a ? ",input,textarea" : "")).filter(function(g, h) {
                return jQuery(h).val() == ""
            }).attr("disabled", "disabled");
            return true
        })
    },
    _tourSearchFormOnDateFieldCloseCallback: function(i) {
        var f = jQuery(i),
            b = f.attr("name"),
            h = b.indexOf("min_") >= 0,
            d = !h && b.indexOf("max_") >= 0;
        if (h || d) {
            if (typeof i.pair == "undefined") {
                var a = b.replace("min_", "").replace("max_", ""),
                    g = f.parents("form").find('[name$="' + a + '"]').not(f);
                i.pair = g.length ? g : null
            }
            if (i.pair) {
                var c = h ? "minDate" : "maxDate";
                if (typeof i.pair.init_value == "undefined") {
                    i.pair.init_value = i.pair.datepicker("option", c)
                }
                i.pair.datepicker("option", c, i.value ? i.value : i.pair.init_value)
            }
        }
    },
    ...
    makeSwiper: function(c) {
        var i = jQuery.extend({
            ...
            widthToSlidesNumber: function(q, p) {
                var o = p;
                if (q > 992) {} else {
                    if (q > 768) {
                        o = Math.ceil(p / 2)
        ...
        var m = i.slidesNumber,
            b = jQuery(i.containerSelector),
            d = b.find(i.sliderElementSelector),
            n = d.find(i.slideSelector).length,
            k = {
                slidesPerView: m,
                spaceBetween: 30,
                loop: m < n
        ...
        if (i.swiperOptions) {
            jQuery.extend(k, i.swiperOptions)
        }
        var l = new Swiper(d, k),
            a = null,
            f = null,
            j = null;
        ...
        var h = true,
            g = function() {
                ...
                if (i.widthToSlidesNumber && "function" == typeof i.widthToSlidesNumber) {
                    o = i.widthToSlidesNumber(jQuery(window).width(), m)
                }
                var p = l.params.slidesPerView != o;
                if (h || p) {
                    if (p) {
                        l.params.slidesPerView = o;
                        l.update()
                    }
                    if (a) {
                        if (o < n && n > 1) {
    ...
    initParallax: function(a) {
        ...
        jQuery(a).each(function() {
            var b = jQuery(this),
                c = b.data("parallax-speed");
            b.parallax("50%", c ? c : 0.4)
        })
    },
    faqAccordionCahgesIcon: function() {
      var c = jQuery(".faq__accordion"),
            f = ".faq__accordion__item",
            b = "faq__accordion__item--open",
            g = ".faq__accordion__heading i",
            a = "fa-info",
            d = "fa-question";
        c.each(function() {
            var h = jQuery(this);
    ...
    _initScrollTop: function(c) {
        var a = c("body, html"),
            b = c(".footer__arrow-top"),
            f = c(window).outerHeight(),
            d = c(a).outerHeight();
        if (f >= d) {
            b.hide()
        }
    ...
    init_faq_question_form: function(c) {
        var b = jQuery(c),
            d = jQuery(".form-block__content"),
            g = jQuery(".form-block__validation-success");
        if (b.length < 1) {
            return
        }
        var a = b.find(".form-block__validation-error"),
            f = function() {
    ...
    initSharrres: function(a) {
        ...
        var d = a.urlCurl ? a.urlCurl : "",
            c = jQuery(a.itemsSelector);
        if (c.length < 1) {
            return
        }
        var b = function() {
            var i = jQuery(this),
                h = i.parent().data("urlshare"),
                g = i.parent().data("imageshare"),
                j = i.data("btntype"),
                f = {
                    urlCurl: d,
                    enableHover: false,
...
Theme.Gallery.prototype = {
    ...
    _initPagination: function() {
        ...
        this._jPager = a.jPages(jQuery.extend({
    ...
    _initFilter: function(b, a) {
        ...
        var d = this,
            c = this.getImagesContEl().children();
        var f = function() {
            if (d._jPager) {
                return
            }
        ...
        g.on("click", function(l) {
            l.preventDefault();
            var i = jQuery(this).data("filterid"),
                k = d.filterButtonActionClass;
            g.parent().removeClass(k);
            jQuery(this).parent().addClass(k);
            if (!i) {
                i = "all"
            }
            var h = i == "all" ? c : c.filter('[data-filterid*="' + i + '"]'),
                j = h,
                m = c.not(h);
...
Theme.FormValidationHelper = {
    ...
    initContactForm7CustomValidtion: function() {
        var b = this,
            a = jQuery(".wpcf7"),
            c = this.options.itemsValidationClass;
        a.each(function() {
            ...
            g.find("form").on("ajaxComplete", function(h) {
                ...
                jQuery(this).find(".wpcf7-not-valid").each(function(k, l) {
                    var l = jQuery(l),
                        j = l.siblings(".wpcf7-not-valid-tip").text();
                    switch (j) {
    ...
    initMailChimpCustomValidtion: function(f) {
        var c = this,
            d = this.options.itemsValidationClass,
            a = jQuery("#" + f);
        if (a.length < 1) {
            return
        }
...
Theme.tourBookingForm = {
        ...
        this.getForm().on("submit", function() {
            ...
            jQuery.ajax({
                ...
                complete: function(h, g) {
                    ...
                    var j = h.responseJSON ? h.responseJSON : {},
                        f = "success" == g && j.success;
                    if (f) {
                        ...
                        var l = j.data && j.data.errors ? j.data.errors : {
    ...
    _initDateSelector: function() {
        ...
        var a = this,
            d = "yy-mm-dd",
            b = this._getDateField(true);
        b.on("change", function() {
            a._renderTimeOptions(b.datepicker("getDate"))
        }).datepicker({
            dateFormat: this.dateFormat ? this.dateFormat : d,
        ...
        if (b) {
            if (!this._cal_date_field) {
                ...
                if (a.data("placeholder")) {
                    this._cal_date_field.attr("placeholder", a.data("placeholder"))
                }
    ...
    _setDateValue: function(a) {
        var c = this._getDateField(),
            b = c.find('option[value^="' + a + '"]').first().attr("value");
        if (b) {
            this._time_prefix = a + " ";
    ...
    _createTimeField: function() {
        var a = this._getDateField(),
            b = jQuery(this.timeSelectorElementTemplate);
        if (b.length < 1) {
            return b
        }
        if (b.is("select")) {
    ...
    _convertAvailableDates: function(f) {
        ...
        var b = "00:00";
        for (var k in f) {
            var c = parseInt(f[k], 10),
                j = this._createDateFromString(k),
                h = jQuery.datepicker.formatDate("yy-mm-dd", j),
                i = h == k ? b : ("0" + j.getHours()).slice(-2) + ":" + ("0" + j.getMinutes()).slice(-2);
            if (!a[h]) {
                a[h] = {
                    all: 0,
                    times: {}
    ...
    _getTimeOptions: function(b) {
        var a = [],
            f = this._availableDateConverted || null;
        if (f && f[b]) {
            var d, c;
            for (d in f[b].times) {
                a.push({
    ...
    _initVariations: function() {
        var h = this.getForm(),
            b = this,
            g = this._getQuantityFields(true),
            f = this.renderPriceDetails && this.itemsDataPriceUrl,
            d = f ? h.find("[name^=wc_deposit_]") : null,
            a = f ? h.find("[name=coupon_field]") : null;
        if (!this.variationsData) {
            if (this.plainPriceData) {
                var i = function() {
                    b._renderPriceDetails(b.plainPriceData)
                };
                this._getDateField().on("change", i);
                g.on("change", i).trigger("change");
                if (a) {
                    a.on("change", i)
                }
                if (d) {
        ...
        var i = function() {
            b._renderPriceDetails(b._current_variation_config)
        };
        this._getDateField().on("change", i);
        g.on("change", i);
        if (d) {
        ...
        var c = function() {
            var j = b._getVariationFor(b._readAttributesValues());
            b._current_variation_config = j;
            if (jQuery.isArray(j)) {
                b._getQuantityFields(true).each(function(k, m) {
                    var o = j[k] ? j[k] : null,
                        l = o && o.variation_id ? o.variation_id : null,
                        n = jQuery(m);
                    b._getVariationFieldForQuanityField(n).val(l).trigger("change");
                    n.prop("disabled", !l)
                })
            } else {
                b._getVariationFieldForQuanityField(b._getQuantityFields(true)).val(j && j.variation_id ? j.variation_id : null).trigger("change")
            }
            b._renderPriceDetails(b._current_variation_config)
        };
        this._attribute_fields = h.find('[name^="attribute_"]').on("change", c);
        c()
    },
    ...
    _getVariationFieldForQuanityField: function(a) {
        var b = jQuery(a),
            c = b.attr("name").replace("quantity_", "");
        if (c == "quantity") {
    ...
    _renderPriceDetails: function(g) {
        ...
        var a = this.getForm(),
            h = a.find("[type=submit]"),
            i = a.find('[data-role="price-explanation"]'),
            b = "form-block__price-details--in-progress";
        var f = function(l, m) {
            i.html(m ? m : "");
            if (l) {
        ...
        if (this.itemsDataPriceUrl) {
            ...
            var j = [],
                d = 0,
                k = this._getQuantityFields(true);
            k.each(function(l, p) {
                var o = parseInt(jQuery(p).val(), 10),
                    m = c[l];
